...
public class TaskDetailVO extends TTaskDetail {
     ...
     * rfid对应数量
     */
    private BigDecimal rfidHeadCount;
    ...
    public BigDecimal getRfidHeadCount() {
        return rfidHeadCount;
    }

    public void setRfidHeadCount(BigDecimal rfidHeadCount) {
    ...
    public Long getCheckResultId() {return checkResultId; }

    public void  setCheckResultId (Long checkResultId) { this.checkResultId = checkResultId;}
