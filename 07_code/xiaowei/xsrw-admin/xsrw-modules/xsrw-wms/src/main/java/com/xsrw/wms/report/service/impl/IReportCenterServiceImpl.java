...
public class IReportCenterServiceImpl implements ITReportCenterService {
     ...
     */
    @Override
    public List<StockMainReportVO> stockWarning(ValidityWarningReportVO param) {

        String materailCode = param.getMaterialCode();
        ...
        List<TStockMain> stockMainList = stockMainMapper.wranList(param);
     ...
     */
    @Override
    public List<ValidityWarningReportVO> getValidityWarning(ValidityWarningReportVO vo) {
        List<ValidityWarningReportVO> voList = stockMapper.getValidityWarning(vo);
        return voList;
    }
