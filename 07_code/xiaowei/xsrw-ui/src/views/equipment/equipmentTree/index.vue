  ...
  <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['wms:equipmentTree:add']"
            >新增</el-button
          >
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['wms:equipmentTree:edit']"
            >修改</el-button
          >
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['wms:equipmentTree:remove']"
            >删除</el-button
          >
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['wms:equipmentTree:export']"
            >导出</el-button
          >
        </el-col>
        <right-toolbar
          :showSearch.sync="showSearch"
          @queryTable="getListTree"
        ></right-toolbar>
      </el-row>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      ...
      >
        ...
        <!-- <el-form-item label="分类" prop="pid">
          <el-input v-model="form.pid" placeholder="请输入分类" />
        </el-form-item> -->
...
// import { listEquipmentTree, getEquipmentTree, delEquipmentTree, addEquipmentTree, updateEquipmentTree } from "@/api/equipment/equipmentTree/equipmentTree";
...
export default {
  ...
  methods: {
    ...
    /** 查询经验库分类树列表 */
    getListTree() {
      listEquipmentTree({ type: 2 }).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download(wms + '/equipmentExpBase/export', { ...this.queryParams }, `equipmentTree_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
