<template>
  <div class="app-container" ><!--v-loading.fullscreen="dialogLoading"-->
    ...
    <el-table v-loading="loading" :data="deliveryDetailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="创建人" align="center" prop="auditor" :show-overflow-tooltip="true" min-width="100" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="250" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['inout:delivery:remove']">删除</el-button>
          <el-button size="mini" type="text" icon="el-icon-document" @click="handleDetailed(scope.row, 1)" v-hasPermi="['inout:delivery:query']">审核</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { delOutDelivery, approveOutDelivery, checkInDelivery, registerInDelivery, getTemplateSelectList, getTemplateMaterialList } from "@/api/inoutDelivery/inDelivery";

import { listOutDeliveryOrder } from "@/api/inoutDelivery/outDelivery";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOutDeliveryOrder(this.queryParams).then((response) => {
