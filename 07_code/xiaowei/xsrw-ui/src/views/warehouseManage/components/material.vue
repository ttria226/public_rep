  ...
  <div class="app-container">
    <el-dialog title="选择物料" :visible.sync="open" width="1200px" append-to-body>
      ...
      <el-table v-loading="loading" :data="materialList" highlight-current-row @current-change="handleCurrentChange">
        <el-table-column label="物料编码" align="center" width="150" prop="code"/>
        <el-table-column label="物料名称" align="center" prop="name"  :show-overflow-tooltip="true" />
        <el-table-column label="规格" align="center" prop="specifications" :show-overflow-tooltip="true" />
...
<script>
  import { getInMaterialSelectList } from "@/api/inoutDelivery/inDelivery";
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        getInMaterialSelectList(this.queryParams).then(response => {
