			...
			<view class="nav_item_All">
				<view class="nav_item2">
					<view v-for="(item,index) in liatDate" :key="index" :class="[isActive1 == index ? 'nav_item_cart' : 'nav_item_cart1']" @click="checked1(item,index)">
						<view class="cart_wapper">
							...
							<view class="nav_item_cart_fontSize">
								...
								<button style="width: 220rpx;margin-right:30rpx;float: right;margin-top: -20rpx;" class="button" type="primary"
									@click="zjClick(item.trayCode)">载具出库</button>
							</view>
							<view class="nav_item_cart_fontSize">
					...
					<!-- <view class="nav_item_bottom">
						<button style="width: 100%;" class="button" type="primary" @click="goPage('./storeList?id='+queryParams.taskId+'&trayCode=' + selItem.trayCode+'&checkType='+selItem.checkType+'&deliveryType='+selItem.deliveryType)">执行盘点</button>
					</view> -->
				</view>
			</view>
