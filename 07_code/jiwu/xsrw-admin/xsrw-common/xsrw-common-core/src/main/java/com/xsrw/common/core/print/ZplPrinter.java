...
//import com.xsrw.common.core.utils.file.StreamUtil;
...
//        //编码
//        PrintDataBackDTO code = p.getText("编码:" + hcBind.getCode(), 54, 70);
//        begin.append(code.getBegin());
//        content.append(code.getContent());
//        // 耗材规格
//        PrintDataBackDTO spec = p.getText("包装:" +  hcBind.getSpec(), 54, 120);
...
//        // 效期
//        PrintDataBackDTO effectDate = p.getText("生产日期:" + DateUtils.parseDateToStr("yyyy-MM-dd",hcBind.getEffectDate()), 54, 270);
...
//        String printerIp = "192.168.1.170";
//        Connection connection =   ConnectionBuilder.build("TCP_MULTI:" + printerIp + ":9100:6101");
...
////        String printerIp = configService.selectConfigByKey("rfid.printer.ip");
//        //打印机连接信息
//        Connection connection = new TcpConnection("192.168.1.170", TcpConnection.DEFAULT_ZPL_TCP_PORT);
//        //返回打印机状态用
//        Map<String,Object> map = new HashMap<String, Object>();
//        map.put("dealState", "success");
//        try {
...
//     */
//    public ZplPrinter() {
//        InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("lib/print/ts24.lib");
//        if(inputStream != null){
//            //这里放自己的ts24.lib位置
//            FileInputStream fis = null;
//            try {
//                fis = StreamUtil.convertToFileInputStream(inputStream);
...
//        HcBind hcBind = new HcBind();
//        hcBind.setName("物料名称");
//        hcBind.setSpec("个");
//        hcBind.setCode("W202310101005");
//        hcBind.setBatchNo("20231010100500001");
//        hcBind.setUniqueCode("20231010100500001111");
//        try {
//            printResult = zplPrinter.printGetEpc(hcBind);
//        } catch (ConnectionException e) {
//            e.printStackTrace();
//        }
//        System.out.println("===================print结束"+printResult.toString());
//    }
//
//
//
