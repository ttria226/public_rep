...
import com.xsrw.wms.inout.domain.vo.TMaterialDetailSVO;
import com.xsrw.wms.inout.domain.vo.TMaterialDetailSZiVO;
...
//    AjaxResult printMaterialDetailByAdvanceId(Long advanceId);
     ...
     * @return
     */
    AjaxResult getRfidList(String rfid);


    /*
    * 物料入库扫描列表
    * */
    List<TMaterialDetailSVO> selectSMMaterialDetailList(TMaterialDetailSDTO tMaterialDetailS1);

    /*
    * 物料入库扫描详情
    */
    List<TMaterialDetailSZiVO> selectSMMaterialDetailZiList(TMaterialDetailSZiDTO tMaterialDetailSZiDTO);
     ...
     * @return
     */
    List<TMaterialDetailVO> selectCheckMaterialDetailList(@Param("trayType") String trayType,@Param("entity") TMaterialDetailVO tMaterialDetailVO);
}
