...
import com.xsrw.wms.inout.domain.vo.TOutboundScanningVO;
...
public interface TOutDeliveryMapper extends BaseMapper<TOutDelivery> {
     ...
     * @return 物料出库扫描详情
     */
   public List<TOutboundScanningVO> selectChuKuList(@Param("tos") TOutboundScanningDTO tOutboundScanningDTO);
}
