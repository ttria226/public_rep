...
public interface ITTaskOutService extends IService<TTaskOut> {
     ...
     * @return
     */
    List<TTrayVO> selectGroundPile(String materialId,String batchCode);
     ...
     * @return
     */
    List<TMaterialDetail> getMaterialRfidList(Long locationId, String batchCode, String rfidHead,Long materialId,Long trayId);
     ...
     * 出库完成反馈弹窗
     * */
    void outFeedback(String taskNo , Integer sort);
}
