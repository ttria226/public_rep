<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="故障等级" prop="equFaultLv">
        <el-select
          v-model="queryParams.equFaultLv"
          placeholder="请选择保养类型"
          clearable
        >
          <el-option
      ...
      <el-form-item label="维修单号" prop="dayNo">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['wms:maintenanceDay:add']"
          >新增工单</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['wms:maintenanceDay:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    <el-table v-loading="loading" :data="maintainOrderList">
      ...
      <el-table-column label="维修单号" align="center" prop="dayNo" />
      ...
      <el-table-column label="故障等级" align="center" prop="equFaultLv">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.equ_fault_lv"
            :value="scope.row.equFaultLv"
          />
        </template>
      </el-table-column>
      <el-table-column
      ...
      <el-table-column label="操作" align="center" fixed="right" width="250">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['wms:maintenanceDay:edit']"
            >编辑</el-button
          >
          <el-button
            size="mini"
            ...
            v-hasPermi="['wms:maintenanceDay:query']"
            >查看</el-button
          >
          <el-button
            size="mini"
            ...
            v-hasPermi="['wms:maintenanceDay:assign']"
          ...
          <el-button
            ...
            v-hasPermi="['wms:maintenanceDay:dayCancel']"
            >撤销</el-button
          >
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="50%" append-to-body>
      ...
      >
        ...
        <el-form-item label="维修日期" prop="timeValue">
          <el-date-picker
            style="width: 100%"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        equFaultLv: [{ required: true, message: '请选择故障等级', trigger: 'change' }],
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMaintainOrder(this.queryParams).then(response => {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.id != null) {
            ...
            addMaintainOrder(this.form).then((response) => {
