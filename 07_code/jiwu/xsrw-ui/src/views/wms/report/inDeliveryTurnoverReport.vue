<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="deliveryTurnoverReportList">
      ...
      <el-table-column label="入库数量" align="center" prop="count" min-width="120px" />
      <el-table-column label="入库时间" align="center" prop="createTime" min-width="150px" />
    </el-table>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download(wms+'/report/center/inOutStatement/export', {...this.queryParams}, `inOutStatement_in_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
