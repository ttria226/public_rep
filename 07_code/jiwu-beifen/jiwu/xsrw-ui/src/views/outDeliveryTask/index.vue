<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="outDeliveryTaskList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出库单号" align="center" prop="originCode" :show-overflow-tooltip="true" min-width="180" />
      <el-table-column label="物料名称" align="center" prop="materialName" :show-overflow-tooltip="true" min-width="180" />
      <el-table-column label="物料编码" align="center" prop="materialCode" :show-overflow-tooltip="true" min-width="180" />
      <!-- <el-table-column label="批次" align="center" prop="code" :show-overflow-tooltip="true" width="100" /> -->
      <el-table-column label="计量单位" align="center" prop="unitName" :show-overflow-tooltip="true" width="120" />
      <el-table-column label="需出库数量" align="center" prop="num" :show-overflow-tooltip="true" width="120" />
<!--      <el-table-column label="小件数量" align="center" prop="smallPredictCount" :show-overflow-tooltip="true" width="150" />-->
      <el-table-column label="出库类型" align="center" prop="type" :show-overflow-tooltip="true" width="100" >
