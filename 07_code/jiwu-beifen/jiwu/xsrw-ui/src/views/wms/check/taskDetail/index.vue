<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="80px">
      ...
      <el-form-item label="盘点策略" prop="checkType">
        <el-select v-model="queryParams.checkType" clearable filterable placeholder="请选择盘点策略">
          <el-option :key="1" label="物料" :value="1"></el-option>
          <el-option :key="2" label="库区" :value="2"></el-option>
          <el-option :key="4" label="随机" :value="4"></el-option>
          <el-option :key="3" label="动碰" :value="3"></el-option>
          <el-option :key="5" label="空货位" :value="5"></el-option>
        </el-select>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="taskDetailList">
      ...
      <el-table-column label="任务号" fixed min-width="180" align="center" prop="code" :show-overflow-tooltip="true" />
      <!-- <el-table-column label="物料号" fixed width="220" align="center" prop="materialCode"  :show-overflow-tooltip="true"/> -->
      <!-- <el-table-column label="物料名称" fixed align="center" prop="materialName"  :show-overflow-tooltip="true"/> -->
      <!-- <el-table-column label="载具"  width="220" align="center" prop="trayCode"  :show-overflow-tooltip="true"/> -->
      <!-- <el-table-column label="状态" fixed align="center" prop="status"  :show-overflow-tooltip="true" :formatter="statusSeeFormat"/> -->
    ...
    <el-dialog title="执行盘点" :visible.sync="inventoryOpen" v-if="inventoryOpen" width="1100px" append-to-body>
      ...
      <el-table :data="inventoryList" ref="inventoryTab">
        ...
        <el-table-column label="实盘数量" align="center" width="150" prop="actualCount" :show-overflow-tooltip="true">
          <template slot-scope="scope">
            <el-input v-if="scope.row.taskStatus != '2'" :ref="'actualCount' + scope.$index" v-model="scope.row.actualCount" @blur="value => handleInventoryActualCountBlur(value,scope.row,scope.$index)" maxlength="9" placeholder="请输入实盘数量" size="small"></el-input>
...
<script>
import { listTaskDetail, performCheck, getTaskDetail, delTaskDetail, addTaskDetail, updateTaskDetail, trayDetail, checkdeliverySubmit, execute, detailList, checkAreaList, checkAreaSave, checkAreaDel, checkAreaSubmit, checkAreaDeliveryUpdate, getInventorySelectLists,  } from "@/api/wms/pdtaskDetail";
