      ...
      <el-form ref="detailForm" :model="detailForm" label-width="100px" style="padding-right: 30px">
        <el-row :gutter="20">
          <el-col :span="8" class="detail-form-item">
            <el-form-item :label="detailType == '1' ? '收货单号' : '入库单号'">
              <span>{{ detailForm.code }}</span>
            </el-form-item>
          </el-col>
          <el-col :span="8" class="detail-form-item">
            <el-form-item :label="detailType == '1' ? '单据类型' : '入库类型'">
              <dict-tag :options="dict.type.in_delivery_type" :value="detailForm.type" />
            </el-form-item>
          </el-col>
          <el-col :span="8" class="detail-form-item">
            <el-form-item :label="detailType == '1' ? '状态' : '入库状态'">
        ...
        <el-form-item label-width="0px" v-if="detailForm.deliveryDetailList && detailForm.deliveryDetailList.length > 0">
          <el-table v-loading="loading" :data="detailForm.deliveryDetailList">
            <!-- <el-table-column label="物料BOM组合" align="center" prop="materialCode" width="200"></el-table-column> -->
            ...
            <el-table-column label="已入库数量" align="center" prop="registrationCount" min-width="120" v-if="detailType == 1"></el-table-column>
            <el-table-column label="单价（元）" align="center" prop="price" width="120" v-if="detailType == 2"></el-table-column>
            <el-table-column label="财务凭证号" align="center" prop="financeVoucherNo" width="120" v-if="detailType == 2"></el-table-column>
<!--            <el-table-column label="登记时间" align="center" prop="producedDate" width="210" v-if="detailType == 4 && detailForm.status >= 2 && detailForm.status != 9"></el-table-column>-->
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <!--<el-button type="primary" @click="submitDetailRegistrationForm" v-if="detailType == 1">收货并上架</el-button>--><!--submitDetailCheckForm-->
        <!-- <el-button type="primary" @click="submitDetailRegistrationForm" v-if="detailType == 3">登记入库</el-button> -->
        <el-button type="primary" @click="submitDetailTemplateForm" v-if="detailType == 2 && detailForm.status >= 2 && detailForm.status != 9">标签打印</el-button>
