      ...
      <el-table v-loading="loading" :data="equList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="text" icon="el-icon-view" @click="handleDetail(scope.row)" v-hasPermi="['wms:equipmentExpBase:edit']">查看</el-button>
...
export default {
  ...
  methods: {
    ...
    /** 查询经验库分类树列表 */
    async getListTree() {
      let resultInfo = await listEquipmentTree({ type: 1, pageSize: 5000 })
    ...
    getList() {
      ...
      //   this.loading = false;
      // })
      listEquipmentExpBase({...this.queryParams, baseType: 2}).then(res => {
        console.log(res)
        this.equList = res.rows
        this.total = res.total;
        this.loading = false;
