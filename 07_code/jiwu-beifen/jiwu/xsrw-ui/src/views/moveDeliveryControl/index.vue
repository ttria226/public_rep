    ...
    <el-table v-loading="loading" :data="moveDeliveryControlList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="250" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text" icon="el-icon-setting" v-if="scope.row.taskStatus != '3' && scope.row.taskStatus != '5' && scope.row.taskStatus != null" @click="handleExecute(scope.row,3)" v-hasPermi="['inout:task:updateStock']">强制完成</el-button>
