...
<!--          <el-table-column label="已拣数量" align="center" prop="availableCount" width="120"></el-table-column>-->
...
export default {
  ...
  methods: {
    ...
    handleChooseRfid(item){
      this.$emit("showMaterialRfid",{ locationId: item.locationId, batchCode: item.batchCode })
    },
    //清空物料rfid信息
