		...
		<view class="content">
			...
			<view class="centre">
				...
				<uni-forms label-position="top" ref="formData" :modelValue="formData" :rules="rules">
					<updateCompent :title="'维修前（照片/视频）'" ref="imgCom" @imgDate="imgDate"></updateCompent>
					<updateCompentCopy :title="'维修后（照片/视频）'" ref="imgCopyCom" @imgDateCopy="imgDateCopy"></updateCompentCopy>
