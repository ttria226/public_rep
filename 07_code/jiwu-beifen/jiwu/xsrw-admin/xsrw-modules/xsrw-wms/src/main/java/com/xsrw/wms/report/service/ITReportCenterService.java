...
public interface ITReportCenterService {
    ...
    List<StockMainReportVO> stockWarning(String materailCode, String materialName, Long warehouseId);
     ...
     * @return
     */
    List<ValidityWarningReportVO> getValidityWarning(String materialCode, String materialName, Long warehouseId);
