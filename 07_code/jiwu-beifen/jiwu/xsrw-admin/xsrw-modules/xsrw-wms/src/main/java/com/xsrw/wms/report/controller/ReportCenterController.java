...
public class ReportCenterController extends BaseController {
    ...
    public TableDataInfo list(String materailCode, String materialName, Long warehouseId) {
        startPage();
        List<StockMainReportVO> stockWarning = itReportCenterService.stockWarning(materailCode, materialName, warehouseId);
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, String materailCode, String materialName, Long warehouseId) {
        List<StockMainReportVO> stockWarning = itReportCenterService.stockWarning(materailCode, materialName, warehouseId);
    ...
    public TableDataInfo validityWarning(String materialCode, String materialName, Long warehouseId) {
        startPage();
        List<ValidityWarningReportVO> stockWarning = itReportCenterService.getValidityWarning(materialCode, materialName, warehouseId);
        TableDataInfo dataTable = getDataTable(stockWarning);
        return dataTable;
    }
    ...
    public void validityWarning(HttpServletResponse response, String materialCode, String materialName, Long warehouseId) {
        List<ValidityWarningReportVO> stockWarning = itReportCenterService.getValidityWarning(materialCode, materialName, warehouseId);
