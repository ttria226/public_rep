...
//    @RequiresPermissions("inout:out:query")
    ...
    public TableDataInfo getMaterialRfidList(Long locationId, String batchCode, String rfidHead,Long materialId) {
        startPage();
        List<TMaterialDetail> rfidList = tTaskOutService.getMaterialRfidList(locationId, batchCode, rfidHead,materialId);
